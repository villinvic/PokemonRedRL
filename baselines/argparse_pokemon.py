...
def get_args(usage_string=None, ep_length=None, sess_path=None, headless=True):
    ...
    parser.add_argument('--action_freq', type=int, default=18, help='Frequency of actions')
    parser.add_argument('--init_state', type=str, default='deepred_post_parcel_pokeballs', help='Initial state of the environment')
    ...
    parser.add_argument('--gb_path', type=str, default='pokered.gbc', help='Path to the gameboy ROM')
    parser.add_argument('--debug', type=bool, default=False, help='Whether to run the environment in debug mode')
    # 40_000_000.0 # 20M # 10M
    parser.add_argument('--sim_frame_dist', type=float, default=600_000.0, help='Simulation frame distance')
